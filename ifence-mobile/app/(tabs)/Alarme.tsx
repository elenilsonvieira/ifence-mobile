...
//       setPoint2({ latitude: newLat, longitude: newLon });

//       const distance = getDistance(cercaSelecionada.latitude, cercaSelecionada.longitude, newLat, newLon);
...
//         <Text style={styles.text}>Longitude: {point2.longitude.toFixed(5)}</Text>
...
//       const newLat = cercaSelecionada.latitude + (Math.random() - 0.5) * maxDistance;
//       const newLon = cercaSelecionada.longitude + (Math.random() - 0.5) * maxDistance;
//       const novaLocalizacao = { latitude: newLat, longitude: newLon, timestamp: new Date().toISOString() };
...
//           onPress={() => navigation.navigate('ListaLocalizacoesPulseira', { pulseiraId: cercaSelecionada.id })}
//         />
//         <Button title="Voltar" onPress={() => setCercaSelecionada(null)} />
//       </View>
//       <Toast />
